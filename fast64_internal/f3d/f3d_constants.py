...
blenderToSM64Rotation = mathutils.Matrix([[0, 1, 0], [0, 0, 1], [1, 0, 0]])

blenderToSM64RotationLevel = mathutils.Matrix([[1, 0, 0], [0, 0, 1], [0, -1, 0]])

colorFormats = {"RGBA": 0, "YUV": 1, "CI": 2, "IA": 3, "I": 4}

pixelBitSizes = {"4bit": 0, "8bit": 1, "16bit": 2, "32bit": 3}
