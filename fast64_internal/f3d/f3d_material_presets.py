...
f3d_mat.rdp_settings.g_shade_smooth = True
f3d_mat.rdp_settings.g_clipping = False
f3d_mat.rdp_settings.g_mdsft_alpha_dither = 'NONE'
f3d_mat.rdp_settings.g_mdsft_rgb_dither = 'NONE'
f3d_mat.rdp_settings.g_mdsft_combkey = 'NONE'
f3d_mat.rdp_settings.g_mdsft_textconv = 'NONE'
f3d_mat.rdp_settings.g_mdsft_text_filt = 'NONE'
f3d_mat.rdp_settings.g_mdsft_textlut = 'NONE'
f3d_mat.rdp_settings.g_mdsft_textlod = 'NONE'
f3d_mat.rdp_settings.g_mdsft_textdetail = 'NONE'
f3d_mat.rdp_settings.g_mdsft_textpersp = 'NONE'
f3d_mat.rdp_settings.g_mdsft_cycletype = 'NONE'
f3d_mat.rdp_settings.g_mdsft_color_dither = 'NONE'
f3d_mat.rdp_settings.g_mdsft_pipeline = 'NONE'
f3d_mat.rdp_settings.g_mdsft_alpha_compare = 'NONE'
f3d_mat.rdp_settings.g_mdsft_zsrcsel = 'NONE'
f3d_mat.rdp_settings.clip_ratio = 1
...
material_presets = {
    ...
    "mk64": {
        f"mk64_{key}": value + 'f3d_mat.presetName = "MK64 " +  f3d_mat.presetName'
        for key, value in homebrew_and_oot.items()
    },
    "oot_f3dex3": {
