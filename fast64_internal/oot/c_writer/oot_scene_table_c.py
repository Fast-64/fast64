import os
from ...utility import bpy, PluginError, writeFile
...
def modifySceneTable(scene, exportInfo):
	...
	writeFile(os.path.join(exportPath, 'include/tables/scene_table.h'), sceneTableToC(fileData, header, sceneNames, scene))
