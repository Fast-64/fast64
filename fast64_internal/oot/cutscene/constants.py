...
ootEnumCSMiscType = [
    ...
    ("CS_MISC_QUAKE_START", "Start Quake", "Start Quake"),
    ("CS_MISC_QUAKE_STOP", "Stop Quake", "Stop Quake"),
    ("CS_MISC_SANDSTORM_FILL", "Sandstorm Fill", "Sandstorm Fill"),
    ("CS_MISC_SUNSSONG_START", "Start Sun's Song", "Start Sun's Song"),
    ...
    ("CS_MISC_TIME_ADVANCE_TO_NIGHT", "Advance Time to Night", "Advance Time to Night"),
    ("CS_MISC_SET_TIME_BASED_LIGHT_SETTING", "Set Time Based on Light Settings", "Set Time Based on Light Settings"),
    ("CS_MISC_FADE_KOKIRI_GRASS_ENV_ALPHA", "Grass fade in Kokiri Forest", "Grass fade in Kokiri Forest"),
    ("CS_MISC_DEKU_TREE_DEATH", "Deku Tree Death", "Deku Tree Death"),
    ("CS_MISC_TRIFORCE_FLASH", "Triforce Flash", "Triforce Flash"),
    ("CS_MISC_HIDE_ROOM", "Hide Current Room", "Hide Current Room"),
    ("CS_MISC_VISMONO_BLACK_AND_WHITE", "Set Screen to Black & White", "Set Screen to Black & White"),
    ("CS_MISC_VISMONO_SEPIA", "Set Screen to Sepia", "Set Screen to Sepia"),
    ...
    ("CS_MISC_LONG_SCARECROW_SONG", "Play Long Scarecrow Song", "Play Long Scarecrow Song"),
    ...
    ("CS_MISC_SET_FLAG_FAST_WINDMILL", "Set Fast Windmill Flag", "Set Fast Windmill Flag"),
    ("CS_MISC_SET_FLAG_WELL_DRAINED", "Set Well Drained Flag", "Set Well Drained Flag"),
    ("CS_MISC_SET_FLAG_LAKE_HYLIA_RESTORED", "Set Lake Hylia Restored Flag", "Set Lake Hylia Restored Flag"),
