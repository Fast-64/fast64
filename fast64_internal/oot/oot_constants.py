...
ootEnumCameraMode = [
    ...
    (
        "0x20",
        "Rotating Background, Bird's Eye C-Up",
        "Rotating Background, Bird's Eye C-Up",
    ),
...
ootEnumMusicSeq = [
    ...
    (
        "0x10",
        "Hyrule Field (Enemy Near Segment 1)",
        "Hyrule Field (Enemy Near Segment 1)",
    ),
    (
        "0x11",
        "Hyrule Field (Enemy Near Segment 2)",
        "Hyrule Field (Enemy Near Segment 2)",
    ),
    (
        "0x12",
        "Hyrule Field (Enemy Near Segment 3)",
        "Hyrule Field (Enemy Near Segment 3)",
    ),
    (
        "0x13",
        "Hyrule Field (Enemy Near Segment 4)",
        "Hyrule Field (Enemy Near Segment 4)",
    ),
    (
        "0x14",
    ...
    (
        "0x6B",
        "King Dodongo & Volvagia Boss Battle",
        "King Dodongo & Volvagia Boss Battle",
    ),
...
ootEnumTransitionAnims = [
    ...
    (
        "0x03",
        "Slow Day/White, Slow Night/Black Fade",
        "Slow Day/White, Slow Night/Black Fade",
    ),
    (
        "0x04",
        "Fast Day/Black, Slow Night/Black Fade",
        "Fast Day/Black, Slow Night/Black Fade",
    ),
    (
        "0x05",
        "Fast Day/White, Slow Night/Black Fade",
        "Fast Day/White, Slow Night/Black Fade",
    ),
    (
        "0x06",
        "Very Slow Day/White, Slow Night/Black Fade",
        "Very Slow Day/White, Slow Night/Black Fade",
    ),
    (
        "0x07",
...
ootEnumSceneID = [
    ...
    (
        "SCENE_JYASINBOSS",
        "Twinrova's Lair & Iron Knuckle Mini-Boss Room (Jyasinboss)",
        "Jyasinboss",
    ),
    ...
    (
        ...
        "Great Fairy's Fountain (Upgrades) (Daiyousei Izumi)",
        "Daiyousei Izumi",
    ),
    (
        "SCENE_YOUSEI_IZUMI_TATE",
        "Fairy's Fountain (Healing Fairies) (Yousei Izumi Tate)",
        "Yousei Izumi Tate",
    ),
    (
        "SCENE_YOUSEI_IZUMI_YOKO",
        "Great Fairy's Fountain (Spells) (Yousei Izumi Yoko)",
        "Yousei Izumi Yoko",
    ),
    ...
    (
        "SCENE_HAIRAL_NIWA_N",
        "Castle Hedge Maze (Night) (Hairal Niwa N)",
        "Hairal Niwa N",
    ),
    ("SCENE_HIRAL_DEMO", "Cutscene Map (Hiral Demo)", "Hiral Demo"),
    (
        "SCENE_HAKASITARELAY",
        "Dampé's Grave & Windmill (Hakasitarelay)",
        "Hakasitarelay",
    ),
    ...
    (
        "SCENE_GANON_DEMO",
        "Ganon's Tower Collapse & Battle Arena (Ganon Demo)",
        "Ganon Demo",
    ),
...
ootEnumCSTransitionType = [
    ...
    (
        "12",
        "To Dim Unk",
        "Fade gSaveContext.unk_1410 255>100, works with scene xn 11/17",
    ),
