...
class OOT_AddDoor(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        bpy.ops.mesh.primitive_cube_add(
            align="WORLD", location=location[:], scale=objScale
        )
        ...
        bpy.ops.object.empty_add(
            type="CUBE", radius=1, align="WORLD", location=location[:]
        )
...
class OOT_AddScene(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        bpy.ops.object.empty_add(
            type="CONE", radius=1, align="WORLD", location=location[:]
        )
        ...
        bpy.ops.object.empty_add(
            type="SPHERE", radius=1, align="WORLD", location=location[:]
        )
