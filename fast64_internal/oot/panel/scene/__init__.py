...
class OOT_ExportScenePanel(OOT_Panel):
    ...
    def draw(self, context):
        from ...c_writer.oot_scene_bootup import OOT_ClearBootupScene  # avoids a circular import
...
def oot_level_register():
    from ...c_writer.oot_scene_bootup import ootSceneBootupRegister  # avoid a circular import
...
def oot_level_unregister():
    from ...c_writer.oot_scene_bootup import ootSceneBootupUnregister  # import a circular import
