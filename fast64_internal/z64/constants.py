...
mm_enum_skybox_config = [
    ("Custom", "Custom", "Custom"),
    ("0x00", "SKYBOX_CONFIG_0", "SKYBOX_CONFIG_0"),
    ("0x01", "SKYBOX_CONFIG_1", "SKYBOX_CONFIG_1"),
    ("0x02", "SKYBOX_CONFIG_2", "SKYBOX_CONFIG_2"),
    ("0x03", "SKYBOX_CONFIG_3", "SKYBOX_CONFIG_3"),
    ("0x04", "SKYBOX_CONFIG_4", "SKYBOX_CONFIG_4"),
    ("0x05", "SKYBOX_CONFIG_5", "SKYBOX_CONFIG_5"),
    ("0x06", "SKYBOX_CONFIG_6", "SKYBOX_CONFIG_6"),
    ("0x07", "SKYBOX_CONFIG_7", "SKYBOX_CONFIG_7"),
    ("0x08", "SKYBOX_CONFIG_8", "SKYBOX_CONFIG_8"),
    ("0x09", "SKYBOX_CONFIG_9", "SKYBOX_CONFIG_9"),
    ("0x0A", "SKYBOX_CONFIG_10", "SKYBOX_CONFIG_10"),
    ("0x0B", "SKYBOX_CONFIG_11", "SKYBOX_CONFIG_11"),
    ("0x0C", "SKYBOX_CONFIG_12", "SKYBOX_CONFIG_12"),
    ("0x0D", "SKYBOX_CONFIG_13", "SKYBOX_CONFIG_13"),
    ("0x0E", "SKYBOX_CONFIG_14", "SKYBOX_CONFIG_14"),
    ("0x0F", "SKYBOX_CONFIG_15", "SKYBOX_CONFIG_15"),
    ("0x10", "SKYBOX_CONFIG_16", "SKYBOX_CONFIG_16"),
    ("0x11", "SKYBOX_CONFIG_17", "SKYBOX_CONFIG_17"),
    ("0x12", "SKYBOX_CONFIG_18", "SKYBOX_CONFIG_18"),
    ("0x13", "SKYBOX_CONFIG_19", "SKYBOX_CONFIG_19"),
    ("0x14", "SKYBOX_CONFIG_20", "SKYBOX_CONFIG_20"),
    ("0x15", "SKYBOX_CONFIG_21", "SKYBOX_CONFIG_21"),
    ("0x16", "SKYBOX_CONFIG_22", "SKYBOX_CONFIG_22"),
    ("0x17", "SKYBOX_CONFIG_23", "SKYBOX_CONFIG_23"),
    ("0x18", "SKYBOX_CONFIG_24", "SKYBOX_CONFIG_24"),
    ("0x19", "SKYBOX_CONFIG_25", "SKYBOX_CONFIG_25"),
    ("0x1A", "SKYBOX_CONFIG_26", "SKYBOX_CONFIG_26"),
    ("0x1B", "SKYBOX_CONFIG_27", "SKYBOX_CONFIG_27"),
]
...
mm_enum_skybox = [
    ("Custom", "Custom", "Custom"),
    ("0x00", "None", "SKYBOX_NONE"),
    ("0x01", "Standard Sky", "SKYBOX_NORMAL_SKY"),
    ("0x02", "SKYBOX_2", "SKYBOX_2"),
    ("0x03", "SKYBOX_3", "SKYBOX_3"),
    ("0x05", "Cutscene Map", "SKYBOX_CUTSCENE_MAP"),
]
