...
def mm_scene_props_register():
    ...
    Object.mm_scene_header = PointerProperty(type=OOTSceneHeaderProperty)
    Object.mm_alternate_scene_headers = PointerProperty(type=OOTAlternateSceneHeaderProperty)
